...
<html>
    ...
    <body>
        ...
        <section id="content">
            ...
            <main>
                            ...
                            <div class="card-body">
                                <div class="container-fluid">
                                    <div class="row g-3 align-items-center">
                                        <div class="col-auto">
                                            <label class="col-form-label" for="text">Operacion</label>
                                        </div>
                                        <div class="col-auto" >
                ...
                <div class="table-data">
                    <div class="order">
                        <div class="head">
                            <h3>Lista Libro Caja y Banco</h3>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th>CODIGO UNICO DE LA OPERACION</th>
                                    <th>FECHA</th>
                                    <th>DESCRIPCION</th>
                                    <th>CODIGO</th>
                                    <th>DENOMINACION</th>
        ...
        <script src="js/LibroCajaBanco.js" type="text/javascript"></script>
