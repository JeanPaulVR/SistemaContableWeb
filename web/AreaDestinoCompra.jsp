...
<html>
    ...
    <body>
                ...
                <div class="contenedor-modal">
                    <div class="modal">
                        ...
                        <form id="formModal">
                            <<div class="form-control">
                                <label for="text">Cuenta Origen</label>
                                <input type="text" name="txtCuenta_origenM" id="cuenta_origenM" placeholder="Cuenta Origen" readonly>
                            </div>
                            <div class="form-control">
                                <label for="text">Cuenta Cargo</label>
                                <input type="text" name="txtCuenta_cargoM" id="cuenta_cargoM" placeholder="Cuenta Cargo">
                            </div>
                            <div class="form-control">
                                <label for="text">Cuenta Abono</label>
                                <input type="text" name="txtCuenta_abonoM" id="cuenta_abonoM" placeholder="Cuenta Abono">
                            </div>
        ...
        <script src="js/DestinoCompra.js" type="text/javascript"></script>
