...
<html>
    ...
    <body>
                ...
                <div class="contenedor-modal">
                    <div class="modal">
                        ...
                        <form id="formModal">
                            ...
                            <div class="form-control">
                                <label for="text">Denominacion</label>
                                <input type="text" name="txtDenominacionM" id="denominacionM" placeholder="Denominacion">
                            </div>
                            <div class="form-control">
                                <label for="text">Pais</label>
                                <input type="text" name="txtPaisM" id="paisM" placeholder="Pais">
                            </div>
                            <div class="form-control">
                                <label for="text">Direccion</label>
                                <input type="text" name="txtDireccionM" id="direccionM" placeholder="Direccion">
                            </div>

                            <div class="form-control">
                                <label for="text">ID Identificacion</label>
                                <input type="text" name="txtidtipoM" id="idtipoM" placeholder="Identificacion">
                            </div>
        ...
        <script src="js/CuentaCorriente.js" type="text/javascript"></script>
