...
@WebServlet(name = "RegistroInvBalCuenta12", urlPatterns = {"/RegistroInvBalCuenta12"})
public class RegistroInvBalCuenta12 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        cell1.setCellValue("FOMATO 3.3: \"LIBRO DE INVENTARIOS Y BALANCES- DETALLE DEL SALDO DE LA CUENTA 12- CUENTAS POR COBRAR COMERCIALES TERCEROS\"");
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (!libros.isEmpty()) {
                ...
                for (int k = 0; k < libros.size(); k++) {
                    ...
                    cell1.setCellStyle(style3);
                    cell1 = row.createCell(4);
                    cell1.setCellValue(libros.get(k).getDebe());
                    cell1.setCellStyle(style3);
                    sum++;
                }
        ...
        response.setHeader("Content-Disposition", "attachment; filename=RegistroInvBalCuenta12.xlsx");
